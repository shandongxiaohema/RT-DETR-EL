...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 ...
                 C2f_UniConvBlock, C2f_LGLB, C2f_ConverseB, C2f_Converse2D, Converse2DC3, Converse2D, RepStem, C2f_GCConv, GCConvC3, GCConv, C2f_CFBlock,CoordSPD,SPD_Dual,SPD_ECA,DSC_SPD,SPD_Omni,
                 SPD_ResAtt, SPD_LFE,CSPOmniKernelPlus,DS_OmniBlock):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
        ...
        # --------------ASF--------------
            ...
            c2 = ch[f] // 4
        elif m in {CSPOmniKernel,DS_OmniBlock,SA_OmniBlock,CSPLSKA}:
            c2 = ch[f]
            args = [c2]
